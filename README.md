...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ecma/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ecma/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ecma**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-ecma",
...
- [ ] Changes are scoped to `ecma` — do not include files for other languages
